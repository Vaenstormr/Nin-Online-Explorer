...
Since **Nin Online Explorer** is an independent open-source tool and does not have a paid digital signature certificate, Windows might show a **"Windows protected your PC"** warning when you first run the application. 
This is a common security measure for community-developed software.
...
> [!TIP]
> This software is 100% open-source. You are encouraged to audit the code in this repository to ensure its safety and transparency.
